...
(function($) {
	...
	var Carousel = {
		...
		setRunnerWidth: function() {
			...
			var width =  this.items.outerWidth(true) * this.noOfItems+10;
...
$('#carousel-voti').carousel({
    itemsPerPage: 7,
    itemsPerTransition: 7,
	easing: 'linear'
});


$('#carousel-note-produzione').carousel({
    itemsPerPage: 7,
	itemsPerTransition: 7,
	easing: 'linear'
});

$('#carousel-firme-film-tv').carousel({
    itemsPerPage: 2,
    itemsPerTransition: 2,
    easing: 'linear'
});

$('#carousel-box-last-tag').carousel({
    itemsPerPage: 1,
    itemsPerTransition: 1,
    easing: 'linear'
});
